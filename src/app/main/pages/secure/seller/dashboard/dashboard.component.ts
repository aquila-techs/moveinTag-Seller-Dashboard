...
export class DashboardComponent implements OnInit {
  ...
  public polarAreaChart = {
    ...
    labels: ['Registered Customers', 'Registered Sellers', 'Approved Sellers', 'Disapproved Sellers'],
    datasets: [
      {
        ...
        data: [this.analyticsArray['buyer-registered'], 
        this.analyticsArray['seller-registered'], 
        this.analyticsArray['approved-seller'], 
        this.analyticsArray['disapproved-seller']
      ],
        borderWidth: 0
      }
    ]
