...
export class PaymentComponent implements OnInit {
  ...
  cancelPayment() {
    ...
    this.userService.cancelSubscriptionCustomer(data).subscribe((res) => {
      this.toster.success(
        "You have cancelled your subscription. You can still use it till end of subscription date and time.",
        "Success!"
      );
  ...
  reactivatePayment(id) {
    ...
    this.userService.reactivateSubscriptionCustomer(data).subscribe((res) => {
