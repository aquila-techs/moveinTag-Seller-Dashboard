...
@Component({
  selector: "app-subscription-renewel",
  templateUrl: "./subscription-renewel.component.html",
  styleUrls: ["./subscription-renewel.component.scss"],
})
export class SubscriptionRenewelComponent
  implements OnInit, AfterContentChecked
{
  ...
  goToNextStep() {
    if (this.phoneCode && this.phone && this.countryName) {
      ...
      if (this.libilityInsurancePhotoChangedEvent) {
        ...
        data.append(
          "libilityInsurance",
          this.libilityInsurancePhotoChangedEvent
        );
        data.append("id", this.user._id);
  ...
  getPaymentStatus() {
    ...
    this.userService.getSubscriptionCustomerInfo(data).subscribe((res) => {
  ...
  getCustomerPaymentMethodDetailInfo() {
    ...
    this.userService
      .getCustomerPaymentMethodDetailInfo(data)
      .subscribe((res) => {
  ...
  getAllTransacrtions() {
    ...
    this.userService.getSubsciptionList(data).subscribe((res) => {
  ...
  cancelPayment() {
    ...
    this.userService.cancelSubscriptionCustomer(data).subscribe((res) => {
  ...
  activePayment() {
    ...
    this.userService.activeSubscriptionCustomer(data).subscribe((res) => {
      this.modalService.dismissAll();
      this.getPaymentStatus();
    });
  }
  ...
  pausePayment() {
    ...
    this.userService.pauseSubscriptionCustomer(data).subscribe((res) => {
      this.modalService.dismissAll();
      this.getPaymentStatus();
    });
  }
