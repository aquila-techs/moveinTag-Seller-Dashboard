...
export class UserService {
  ...
  getAllPendingApprovalSeller(queryParams) {
    return this._http.post(
      "admin/get-all-pending-approval-seller" + queryParams,
      {}
    );
  }
  ...
  getSellerCategoriesOnly(id) {
    return this._http.get(
      "seller-category/get-seller-categories-only?userId=" + id
    );
  }
  ...
  sendEmailOnCardDecline(body) {
    return this._http.post("payment/sendEmailOnCardDeclie", body);
  }
